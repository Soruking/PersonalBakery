...
import com.superduperboi.website.styles.ButtonStyle
import com.superduperboi.website.styles.SocialIconStyle
    ...
    Column(
        ...
        Surface(
            modifier = Modifier
                ...
                .margin(bottom = 24.px)
                .background(
                    if (colorMode.isLight) Res.Theme.MAIN.color
                    else Res.Theme.LIGHT_CARD.color
                )
                .align(
        ...
        Button(
            modifier = ButtonStyle.toModifier()
                .margin(bottom = 50.px),
            size = ButtonSize.LG,
            onClick = { window.location.href = Res.String.MY_MENU }
        ) {
            SpanText(
                modifier = Modifier
                    .fontSize(14.px)
